...
export declare class PartService {
    ...
    create(payload: CreatePart): Promise<import("@mikro-orm/core").Loaded<Part, "attributes.group" | "attributes.options">>;
    createDraft(payload: CreateDraft): Promise<Part>;
    find(filters: FilterEntity<Part>): Promise<import("@mikro-orm/core").Loaded<Part, any>[]>;
    findOne(id: string): Promise<import("@mikro-orm/core").Loaded<Part, "attributes" | "attributes.group" | "attributes.options">>;
    ...
    addCategory(id: string, categoryId: string): Promise<import("@mikro-orm/core").Loaded<Part, "attributes" | "attributes.group" | "attributes.options">>;
