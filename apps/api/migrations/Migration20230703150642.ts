...
export class Migration20230703150642 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "manufacturer" ("id" uuid not null, "name" varchar(255) not null, "search_index" tsvector not null, "address" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, constraint "manufacturer_pkey" primary key ("id"));');
    this.addSql('create index "manufacturer_search_index_index" on "public"."manufacturer" using gin("search_index");');

    this.addSql('create table "option_config" ("id" uuid not null, "price" int not null default 0, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "option_id" uuid not null, constraint "option_config_pkey" primary key ("id"));');
